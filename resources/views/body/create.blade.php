<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8"> {{-- Lebar diubah ke 5xl --}}
            <div class="bg-white border border-gray-200 rounded-2xl shadow-lg p-8 transition hover:shadow-xl">
                ...
                <div class="mb-6 border-b pb-4 flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                        <i class="fa-solid fa-plus-circle text-blue-600"></i> Form Tambah Data Body
                    </h3>
                ...
                <form action="{{ route('body.store') }}" method="POST" class="space-y-6">
                    @csrf
            ...
            container.addEventListener('click', function (e) {
                if (e.target.classList.contains('remove-bahan-row') || e.target.closest('.remove-bahan-row')) {
                    ...
                    if (container.querySelectorAll('.bahan-row').length > 1) {
                        ...
                        // Ganti alert bawaan dengan konfirmasi visual yang lebih baik jika memungkinkan,
                        // atau biarkan alert jika tidak ada library UI
